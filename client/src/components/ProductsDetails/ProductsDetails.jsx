...
export const ProductsDetails = () => {
  ...
  let handleAddToCart = (event) => {
    if (
      ...
      alert(
        "Ya contiene este producto en su talle, porfavor modifiquelo desde el carrito"
      );
    }
  };
  ...
  const selectSize = (event) => {
    if (printStock[0][event.target.value] === 0) {
      setCount(0);
      setPrice(0);
    } else {
      setStock(printStock[0][event.target.value]);
      setCount(1);
        ...
        <div className="columns">
          ...
          <div className="column is-two-fifths pl-6">
            ...
            <div className="pl-6 pr-6">
              {detail.stock
                ? Object.keys(detail.stock).map((item, index) => {
                    return (
                      <button
                        onClick={selectSize}
                        value={item}
            ...
            <div className="pl-6 pr-6 card-header-title ">
              ...
              <p className="control">
                <Link className="button is-primary" to="">
                  ...
                  <span onClick={(event) => handleAddToCart(event)}>
                    Add to cart
                  </span>
                </Link>
              </p>
                ...
                <Carousel responsive={responsive}>
                  {recomended.map((item, index) => (
                    <div className="fileee pt-6 has-text-centered has-text-weight-bold is-flex-direction-column">
                      <a
                        href={"http://127.0.0.1:5173/products/" + item.name}
                        key={index}
                      >
                        <img
                          className=" image "
          ...
          <div className="columns is-centered">
            <div className="column is-9">
              ...
              <div className="is-flex-direction-row pt-6 has-text-centered background-e">
                ...
                {Object.values(commentsReviews[0].reviews) ? (
                  Object.values(commentsReviews[0].reviews)
                    .slice(0, 2)
                    .map((item, index) => (
                      <div className=" pt-2 pb-2 border-bottom">
                        <div className="columns pt-3 pb-4">
                          <div className="column is-one-quarter ">
                            <h1 className="title is-size-5" key={index}>
                              {item.user}
                            </h1>
                          </div>
                        ...
                        <div className="columns pt- pb-0">
                          <div className="column is-one-quarter ">
                            <h1 className="title is-size-5">{item.rating}</h1>
                          </div>
                          <div className="column">
              ...
              <div className="background-e">
                ...
                <div className="columns pt-3 is-centered has-text-left">
                  <div className="column">
                    {Object.values(commentsReviews[0].comments) &&
                      Object.values(commentsReviews[0].comments)
                        .slice(0, 2)
                        .map((item, index) => (
                          <div key={index}>
                            <div className="columns my-0 pl-6 pt-2">
                              <div className="column">
                                <h1 className="is-size-4 ">{item.user}</h1>
