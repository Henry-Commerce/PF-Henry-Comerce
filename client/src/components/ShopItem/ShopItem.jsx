...
export const ShopItem = ({product, lsCartProducts,setLsCartProducts,handleAmount}) => {
  ...
  useEffect(() => {
    ...
    const cartFilter = lsCartProducts.filter((e) => e.cartId !== product.cartId);
      ...
      <div className='mb-3-tablet mb-auto columns is-vcentered is-multiline' style={{
        ...
        <div className='column is-6-desktop is-7-tablet mb-0-tablet'>
          ...
          <div className='columns is-vcentered is-multiline'>
            ...
            <div className='column is-8'>
              ...
              <p className='mb-0 has-text-grey has-text-left'>{product.categoria}</p>
        ...
        <div className='column is-2-desktop is-3-tablet pl-0'>
          <div
            ...
            <button onClick={handleMin} className='button has-text-black is-ghost '>
              <MdRemove />
            </button>
            <button  className='input has-text-centered'>{count}</button>
              
            <button onClick={handlePlus}className='button has-text-black is-ghost'>
              <MdAdd />
            </button>
          </div>
        </div>
