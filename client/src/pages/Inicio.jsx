              ...
              <div className='has-background-white pt-4 px-10 pb-10 is-relative'>
                ...
                <a className='mt-6 mb-2 px-6 is-block' href='#'>
                  <img
                    ...
                    alt=''
                  />
                  <h5 className='title is-size-5 mb-2'>BRILE water filter</h5>
              ...
              <div className='has-background-white pt-4 px-10 pb-10 is-relative'>
                ...
                <a className='mt-6 mb-2 px-6 is-block' href='#'>
                  <img
                    ...
                    alt=''
                  />
                  <h5 className='title is-size-5 mb-2'>Bicycle S20</h5>
                  <p>
              ...
              <div className='has-background-white pt-4 px-10 pb-10 is-relative'>
                ...
                <a className='mt-6 mb-2 px-6 is-block' href='#'>
                  <img
                    ...
                    alt=''
                  />
                  <h5 className='title is-size-5 mb-2'>Kiteboard WH</h5>
                  <p>
                    <span className='has-text-info is-size-5 has-text-weight-bold'>
                      $199.90
                    </span>
